...
public class CompanyTabCompleter extends SubCommandCompleter {
    ...
    public List<String> onTabComplete(CommandSender sender, String[] args) {
        ...
        //Else check permissions for all sub-commands. Remove sub-command if player does not have permission to use it
